...
<head>
 ...
 <style>
  ...
  margin-bottom: 120px; /* Add margin to the top */
}
 .logo {
      position: absolute;
      top: 10px;
...
<body>
  ...
  <div class="center">
    <div class="form-container">
      <form action="getfaculty.jsp" method="post">
        <h2>Feedback</h2>
...
%>
<h3>Department: <%= branchFullName %></h3>
        ...
        <% 
           ...
           try {
        	    ...
        	    String sql = "SELECT subject_name FROM subject_data WHERE regulation = '" + regulation + "' AND branch = '" + branch + "' AND year = " + year + " AND semester = " + semester + " AND AcademicYear = '" + AcademicYear + "'";
